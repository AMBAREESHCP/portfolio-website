...
// set public key
  ...
  emailjs.init('854350fwmPP8QH8pi');
})()
...
btn.addEventListener("click", (e) => {
  ...
  if (email.includes("@")) {
    ...
    document.querySelector("#em").innerHTML = "its not a valid format";
    valid.email=false;
  }
  if ((valid.name && valid.email)) {
    let subject = document.querySelector("#subject").value;
    let message = document.querySelector("#message").value;
    emailjs.send('service_zhx9dn8', 'template_hs2ba3h', { sub: subject, msg: message, from_name: nam, ema: email })
      .then(function () {
        console.log('SUCCESS!');
      }, function (error) {
